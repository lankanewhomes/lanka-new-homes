...
const AMENITY_SYNONYMS: Record<string, RegExp> = {
  ...
  "Basketball Court": /\bbasket ?ball\b/i,
  "Badminton Court": /\bbadminton\b/i,
  "Jogging Track": /\bjogging (track|path)s?\b/i,
  "Cycling Paths": /\b(cycling|bicycle) (path|track)s?\b/i,
  "Roof Terrace": /\b(roof ?top|roof) (terrace|garden)\b/i,
  "BBQ Area": /\b(bbq|barbecue) (area|deck|pit)\b/i,
  "Kids Pool": /\b(kids'?|kiddies'?|children'?s) (swimming )?pool\b/i,
  "Yoga & Meditation Area": /\byoga\b.*\bmeditation\b/i,
  "Camping Area": /\bcamping\b/i,
  "Pet Friendly": /\bpet[\s-]*friendly\b/i,
