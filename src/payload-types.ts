...
export interface Project {
  ...
  social?: {
    /**
     * Leave blank to use the default caption built from this listing (shown above). Instagram does not link URLs in captions — the site link is for Facebook and copy-paste.
     */
    caption?: string | null;
    /**
     * Fires once, on the save that publishes the listing, and only when the Meta accounts are connected. Assets must be generated first.
     */
...
/**
 * Generated by the social renderer CLI. Preview and post from the project's Social tab.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface SocialAsset {
  ...
  /**
   * What the generator used (photo count, depth on/off, plan scenes).
   */
  notes?: string | null;
  updatedAt: string;
  createdAt: string;
...
export interface SocialPost {
  ...
  kind: 'carousel' | 'reel';
  status: 'published' | 'processing' | 'failed' | 'dry_run';
  /**
   * Post / video / media id on Meta.
   */
  externalId?: string | null;
  /**
   * Instagram container id (until published).
   */
  ...
  error?: string | null;
  /**
   * User email, or "auto-post".
   */
  triggeredBy?: string | null;
  /**
   * Media URLs sent (dry runs keep the whole would-be request here).
   */
  details?:
    | {
        [k: string]: unknown;
