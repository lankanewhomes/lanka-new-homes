      ...
      tabs: [
        ...
        },
        {
          ...
          fields: [
            ...
            { name: 'constructionStarted', type: 'text' },
          ...
          fields: [
            ...
            unitFeaturesField,
            {
              ...
              fields: [
                ...
                { name: 'icon', type: 'select', options: FACT_ICON_OPTIONS, required: true },
              ],
            },
          ...
          fields: [
            {
              ...
              fields: [
                ...
                { name: 'basement', type: 'text' },
                { name: 'garage', type: 'text' },
