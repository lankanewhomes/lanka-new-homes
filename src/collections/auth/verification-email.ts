...
// Same idea as renderVerificationEmailHTML above, for auth.forgotPassword —
// resetURL is Payload's own built-in /cms/reset/:token page (no custom page
// needed, same as verify's /cms/users/verify/:token).
...
<body style="margin:0; padding:0; background-color:#f5f5f0; font-family:Helvetica, Arial, sans-serif;">
  <div style="display:none; max-height:0; overflow:hidden; mso-hide:all;">
    Reset your Lanka New Homes password.
  </div>
    ...
    <tr>
      <td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%; max-width:480px; background-color:#ffffff; border-radius:8px; overflow:hidden;">
          ...
          <tr>
            <td align="center" style="padding:16px 32px 0;">
              <h1 style="margin:0; font-size:22px; line-height:1.3; color:#1f1f1f; font-weight:700;">Reset your password</h1>
            </td>
          </tr>
          ...
          <tr>
            <td align="center" style="padding:16px 32px 0;">
              <p style="margin:0; font-size:15px; line-height:1.6; color:#4a4a4a;">
                We received a request to reset your Lanka New Homes password. Click below to choose a new one.
          ...
          <tr>
            <td align="center" style="padding:12px 32px 32px;">
              <p style="margin:0; font-size:12px; line-height:1.5; color:#9a9282; word-break:break-all;">
                Or paste this link into your browser:<br>
                <a href="${resetURL}" style="color:#9a9282;">${resetURL}</a>
              </p>
            </td>
          </tr>
