...
export default async function DeveloperDashboardPage() {
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[220px_1fr] lg:pt-8">
      <DashboardSidebar links={[{ label: "Overview", href: "/developers/dashboard" }, { label: `${developer?.name ?? "Company"} projects`, href: `/admin/developers/${developerSlug}/projects` }, { label: "Homepage Hero", href: "/developers/dashboard/homepage-hero" }, { label: "Featured Placement", href: "/developers/dashboard/featured" }, { label: "Profile", href: `/developers/${developerSlug}` }]} />
