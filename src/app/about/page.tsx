...
export const metadata: Metadata = {
  title: "About",
  description: "LankaLiving connects buyers with new construction homes and trusted developers across Sri Lanka.",
...
export default function AboutPage() {
  return (
    <div className="static-page-shell">
      <h1>About LankaLiving</h1>
      <p className="static-page-lede">LankaLiving is Sri Lanka&apos;s marketplace for new construction homes, connecting buyers with verified developers, ongoing projects, and the neighborhoods they&apos;re built in.</p>
