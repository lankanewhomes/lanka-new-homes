...
- **Slug:** `rush-broadway-grandpass` · **Developer:** Rush Lanka Group · **Published:** no
- **Source:** https://www.rushlankagroup.com/projects/rush-broadway-grandpass (listed under Completed Projects: https://www.rushlankagroup.com/projects/completed)
- **Location:** Grandpass, Grandpass, Colombo District, Western Province
- **Type / status:** Apartments · Completed · units 18 · floors — · beds 3 · expected handover 2011
- **Payment plan badge:** — · **Deposit terms:** —
- **Brochure on listing:** —
- **Live:** /projects/rush-broadway-grandpass

## Floor plans

| Plan | Beds | Baths | SqFt | Perches | 2D | m² | 3D | Downloads | Availability | Available floors |
|---|---|---|---|---|---|---|---|---|---|---|
| Unit A | 3 | 3 | 1375 | — | ✅ | — | — | — | Sold Out | — |
| Unit B | 3 | 3 | 1325 | — | ✅ | — | — | — | Sold Out | — |
| Unit C | 3 | 3 | 1475 | — | ✅ | — | — | — | Sold Out | — |

## Media (Cloudflare R2, media.lankanewhomes.com)

- Hero: https://media.lankanewhomes.com/projects/rush-broadway-grandpass/gallery/rush-broadway-grandpass_exterior-01.jpg
...
- Key Features groups: Specifications (23), General Features (19)
- Nearby places: 0
