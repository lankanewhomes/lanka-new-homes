...
- **Slug:** `rush-tower-dehiwala` · **Developer:** Rush Lanka Group · **Published:** no
- **Source:** https://www.rushlankagroup.com/projects/rush-tower-dehiwala (listed under Completed Projects: https://www.rushlankagroup.com/projects/completed)
- **Location:** Dehiwala, Dehiwala, Colombo District, Western Province
- **Type / status:** Apartments · Completed · units 24 · floors — · beds 3 · expected handover 2018
- **Payment plan badge:** — · **Deposit terms:** —
- **Brochure on listing:** —
- **Live:** /projects/rush-tower-dehiwala

## Floor plans

| Plan | Beds | Baths | SqFt | Perches | 2D | m² | 3D | Downloads | Availability | Available floors |
|---|---|---|---|---|---|---|---|---|---|---|
| Unit A | 3 | 3 | 1530 | — | ✅ | — | — | — | Sold Out | — |
| Unit B | 3 | 3 | 1490 | — | ✅ | — | — | — | Sold Out | — |
| Unit C | 3 | 3 | 1200 | — | ✅ | — | — | — | Sold Out | — |

## Media (Cloudflare R2, media.lankanewhomes.com)

- Hero: https://media.lankanewhomes.com/projects/rush-tower-dehiwala/gallery/rush-tower-dehiwala_exterior-01.jpg
...
- Key Features groups: Specifications (23), General Features (27)
- Nearby places: 0
