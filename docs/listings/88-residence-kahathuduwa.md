...
- **Location:** Kahathuduwa, Kahathuduwa, Colombo District, Western Province
- **Type / status:** House · Now Selling · units — · floors — · beds — · expected handover —
- **Payment plan badge:** — · **Deposit terms:** yes
- **Brochure on listing:** https://media.lankanewhomes.com/projects/88-residence-kahathuduwa/brochure/88-residence-kahathuduwa_brochure.pdf
- **Live:** /projects/88-residence-kahathuduwa

## Floor plans

| Plan | Beds | Baths | SqFt | Perches | 2D | m² | 3D | Downloads | Availability | Available floors |
|---|---|---|---|---|---|---|---|---|---|---|
| TYPE A | 3 | 2 | 1490 | — | ✅ | — | — | — | Available | — |
| TYPE B | 3 | 2 | 1354 | — | ✅ | — | — | — | Available | — |
| TYPE C | 3 | 2 | 1282 | — | ✅ | — | — | — | Available | — |
...
- 88-residence-kahathuduwa_brochure.pdf (attached)

## Notes, assumptions & gaps

- All 3 types confirmed: A (3bd/2ba/1,490 sqft), B (3bd/2ba/1,354 sqft), C (3bd/2ba/1,282 sqft) — each a 2-storey unit, ground+first floor areas summed per drawing.
