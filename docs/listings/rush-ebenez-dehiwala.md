...
- **Slug:** `rush-ebenez-dehiwala` · **Developer:** Rush Lanka Group · **Published:** no
- **Source:** https://www.rushlankagroup.com/projects/rush-ebenez-dehiwala (listed under Completed Projects: https://www.rushlankagroup.com/projects/completed)
- **Location:** Dehiwala, Dehiwala, Colombo District, Western Province
- **Type / status:** Apartments · Completed · units 26 · floors — · beds 3 · expected handover 2014
- **Payment plan badge:** — · **Deposit terms:** —
- **Brochure on listing:** —
- **Live:** /projects/rush-ebenez-dehiwala

## Floor plans

| Plan | Beds | Baths | SqFt | Perches | 2D | m² | 3D | Downloads | Availability | Available floors |
|---|---|---|---|---|---|---|---|---|---|---|
| Unit A | 3 | 3 | 1260 | — | ✅ | — | — | — | Sold Out | — |
| Unit B | 3 | 3 | 1260 | — | ✅ | — | — | — | Sold Out | — |
| Unit C | 3 | 3 | 1010 | — | ✅ | — | — | — | Sold Out | — |
| Unit D | 3 | 3 | 1240 | — | ✅ | — | — | — | Sold Out | — |

## Media (Cloudflare R2, media.lankanewhomes.com)

- Hero: https://media.lankanewhomes.com/projects/rush-ebenez-dehiwala/gallery/rush-ebenez-dehiwala_exterior-01.jpg
- Property photos (gallery/): 7 · amenity photos (amenities/): 0 · road map: —
- Construction updates (dated photos): 0

## Data captured

- Amenities: Security, Parking, Rooftop
- Key Features groups: Specifications (20), General Features (20)
- Nearby places: 0
...
- None published on the project page.
...
- Rush's unit tracker lists 24 rows while its page headline says 26 apartments — their own numbers disagree; the headline is used for total units. Only a 2D drawing is published for each unit (no 3D render).

_Generated 2026-09-21 from the live Payload record._
