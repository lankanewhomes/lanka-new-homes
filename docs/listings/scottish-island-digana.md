...
- **Location:** Digana, —, Kandy District, Central Province
- **Type / status:** House · Now Selling · units — · floors — · beds — · expected handover —
- **Payment plan badge:** — · **Deposit terms:** —
- **Brochure on listing:** https://media.lankanewhomes.com/projects/scottish-island-digana/brochure/scottish-island-digana_brochure.pdf
- **Live:** /projects/scottish-island-digana
...
- scottish-island-digana_brochure.pdf (attached)

## Notes, assumptions & gaps

- All 3 types confirmed: A (3bd/2ba/1,856 sqft, has an explicit summary block on its drawing), B and C (3bd/3ba each — no legible total sqft printed on either floor of B/C's drawings, left blank/"Contact for pricing"-style rather than guessed).
