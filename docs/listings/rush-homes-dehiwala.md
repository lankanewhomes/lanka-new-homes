...
- **Slug:** `rush-homes-dehiwala` · **Developer:** Rush Lanka Group · **Published:** no
- **Source:** https://www.rushlankagroup.com/projects/rush-homes-dehiwala (listed under Completed Projects: https://www.rushlankagroup.com/projects/completed)
- **Location:** Dehiwala, Dehiwala, Colombo District, Western Province
- **Type / status:** Apartments · Completed · units 32 · floors — · beds 3 · expected handover 2015
- **Payment plan badge:** — · **Deposit terms:** —
- **Brochure on listing:** —
- **Live:** /projects/rush-homes-dehiwala

## Floor plans

| Plan | Beds | Baths | SqFt | Perches | 2D | m² | 3D | Downloads | Availability | Available floors |
|---|---|---|---|---|---|---|---|---|---|---|
| Unit A | 3 | 3 | 1160 | — | ✅ | — | — | — | Sold Out | — |
| Unit B | 3 | 3 | 1225 | — | ✅ | — | — | — | Sold Out | — |
| Unit C | 3 | 3 | 1160 | — | ✅ | — | — | — | Sold Out | — |
| Unit D | 3 | 3 | 1140 | — | ✅ | — | — | — | Sold Out | — |

## Media (Cloudflare R2, media.lankanewhomes.com)

- Hero: https://media.lankanewhomes.com/projects/rush-homes-dehiwala/gallery/rush-homes-dehiwala_exterior-01.jpg
...
- Key Features groups: Specifications (23), General Features (10)
- Nearby places: 0
...
- Only a 3D plan render is published for each unit (no 2D drawing) — the render is used as the plan image.
