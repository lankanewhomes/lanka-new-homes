...
-- 2026-09-08 follow -> notification digest
-- (supabase/migrations/20260908140000_project_notification_snapshots.sql).
-- Last-notified values per project, diffed weekly by the follower-digest
-- cron (src/lib/follower-digest.ts) so it only emails a followed
-- developer's buyers about what's actually new since last week.
